package com.jarvis.psycex.dictionary;
...
//import android.support.v7.widget.SearchView; Keep using android.widget.SearchView. android.support.v7.widget.SearchView is for AppCompatActivity Class
...
public class SearchableDictionary extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bar.setTitle(getResources().getString(R.string.dictionary_name));
    ...
    private void showResults(String query) {
        ...
        if (cursor == null) {
            ...
            SimpleCursorAdapter words = new SimpleCursorAdapter(this,
                    R.layout.dictionary_result, cursor, from, to);
